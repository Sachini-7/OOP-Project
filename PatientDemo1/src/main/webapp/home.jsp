...
<table style="width: 100%; background-color: #B3BFBF; border-radius: 12px; padding: 35px;" border="0">
    ...
    <div class="container">
        <table border="2" align="center" style="width: 50%; border-color: black;" class="centered-table">
            <tr><th><br>
                <a class="Select_btn btn1" onclick="window.location.href='login.jsp'" type="button">Patient Login</a><br><br>
                <a class="Select_btn btn1" onclick="window.location.href='#'" type="button">Doctor Login</a><br><br>
                <a class="Select_btn btn1" onclick="window.location.href='#'" type="button">Receptionist Login</a><br><br>
